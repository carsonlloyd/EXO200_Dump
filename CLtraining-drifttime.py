...
def train_DTR(cut,opt):
	...
	scint_count = data['scint_count']
	collection_time = data['collection_time']
	drift_time = data['drift_time']
	time = data['time']
	U = data['U']
	detector_half = data['detector_half']
	...
	apd_train, apd_test, pos_train, pos_test, ce_train, ce_test, sc_train, sc_test, ct_train, ct_test, dt_train, dt_test, time_train, time_test, U_train, U_test, dh_train, dh_test = cross_validation.train_test_split(apd_data, position, charge_energy, scint_count, collection_time, drift_time, time, U, detector_half, test_size = 0.3)
	...
	testing_predictions['charge_energy'] = ce_test
	testing_predictions['scint_count'] = sc_test
	testing_predictions['collection_time'] = ct_test
	testing_predictions['drift_time'] = dt_test
	testing_predictions['time'] = time_test
	testing_predictions['U'] = U_test
	testing_predictions['detector_half'] = dh_test
